...
public record ResponseClienteDto(
    ...
    public ResponseClienteDto(Cliente cliente){
        this(cliente.getIdCliente(), cliente.getNome(), cliente.getCpf(), cliente.getRg(), cliente.getLogin(), cliente.getSenha(), cliente.getDataNascimento(), cliente.getEmails(), cliente.getContatos());
    }
}
